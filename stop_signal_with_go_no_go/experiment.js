...
var end_block = {
	...
	'<p class = center-block-text>Press<strong> enter</strong> to continue.</p>'+
	'</div>',
	cont_key: [13],
	timing_post_trial: 0
};
...
var instructions_block = {
	...
	pages:[
		...
		"<div class = centerbox>"+
			...
			'<p class = block-text>We will show you what a trial looks like when you finish instructions. Please make sure you understand the rules before moving on.</p>'+
		"</div>",
	],
	allow_keys: false,

...
var threebytwo_copy_experiment = [];
threebytwo_copy_experiment.push(instruction_node);
threebytwo_copy_experiment.push(start_practice_block);
for (var i = 0; i < practice_length; i++) {
  threebytwo_copy_experiment.push(setStims_block)
  threebytwo_copy_experiment.push(fixation_block)
  threebytwo_copy_experiment.push(cue_block);
  threebytwo_copy_experiment.push(practice_block);
  threebytwo_copy_experiment.push(gap_block);
}
threebytwo_copy_experiment.push(attention_node)
threebytwo_copy_experiment.push(start_test_block)
for (var i = 0; i < test_length; i++) {
  threebytwo_copy_experiment.push(setStims_block)
  threebytwo_copy_experiment.push(fixation_block)
  threebytwo_copy_experiment.push(cue_block);
  threebytwo_copy_experiment.push(test_block);
}
threebytwo_copy_experiment.push(attention_node)
threebytwo_copy_experiment.push(post_task_block)
threebytwo_copy_experiment.push(end_block)

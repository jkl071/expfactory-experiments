...
function addID() {
  jsPsych.data.addDataToLastTrial({exp_id: 'cue_control_food_practice', subject_ID: subject_ID})
}
...
var cue_control_food_practice_experiment = []

cue_control_food_practice_experiment.push(welcome_block);

cue_control_food_practice_experiment.push(instructions_block);

cue_control_food_practice_experiment.push(training_node);

cue_control_food_practice_experiment.push(end_block);

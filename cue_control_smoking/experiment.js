...
for(var i=0;i<preloadControlNonFood.length;i++){
	images.push("/static/experiments/cue_control_smoking/images/control_non_food/" + preloadControlNonFood[i] + ".bmp")
}
...
var ratingBoard1 = 
	'<div class = bigbox>'+
		...
		'<p class = center-textJamie style="font-size:26px"><font color = "white">Please rate how much you currently want to use the item.</font></p>'+
		'</div>'+
...
var testratingBoard1 = 
	'<div class = bigbox>'+
		'<div class = practice_rating_text>'+
		'<p class = center-textJamie style="font-size:26px"><font color = "white">Please rate how much you currently want to use the item, '
...
cue_control_smoking_experiment.push(scanner_wait_block);

cue_control_smoking_experiment.push(training_node);
/*
cue_control_smoking_experiment.push(post_rating_intro);

cue_control_smoking_experiment.push(post_rating_node);
*/

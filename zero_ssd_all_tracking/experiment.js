...
function addID() {
  jsPsych.data.addDataToLastTrial({exp_id: 'zero_ssd_all_tracking', subject_ID: subject_ID})
}
...
var appendData = function(){
	...
	jsPsych.data.addDataToLastTrial({
		...
		trial_type: stimData.trial_type,
	})
	currTrial += 1
	...
	if (testPhase == "test"){	
		...
		curr_trial = jsPsych.progress().current_trial_global
		if((jsPsych.data.getDataByTrialIndex(curr_trial).rt == -1) && (SSD<850) && (jsPsych.data.getDataByTrialIndex(curr_trial).stop_type == 'stop')){
			SSD = SSD + 50
		} else if ((jsPsych.data.getDataByTrialIndex(curr_trial).rt != -1) && (SSD>0) && (jsPsych.data.getDataByTrialIndex(curr_trial).stop_type == 'stop')){
			SSD = SSD - 50
		}
...
var pathSource = "/static/experiments/zero_ssd_all_tracking/images/"
var fileType = ".png"
...
var zero_ssd_all_tracking_experiment = []

zero_ssd_all_tracking_experiment.push(welcome_block);
zero_ssd_all_tracking_experiment.push(instructions_block);
/*
zero_ssd_all_tracking_experiment.push(practice_intro);
zero_ssd_all_tracking_experiment.push(practiceNode);
zero_ssd_all_tracking_experiment.push(feedback_block);
*/
zero_ssd_all_tracking_experiment.push(test_intro);
zero_ssd_all_tracking_experiment.push(testNode);
zero_ssd_all_tracking_experiment.push(feedback_block);

zero_ssd_all_tracking_experiment.push(end_block);
